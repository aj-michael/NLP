 ...
 *  Preprocess.java or PreprocessRec2.java
 *  
 *  Ben, your turn.
 */
public class DocumentSummarizer2 {
	...
	public DocumentSummarizer2(Counter<String> df) {
		this.df = df;
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		DocumentSummarizer2 summarizer = new DocumentSummarizer2(df);
